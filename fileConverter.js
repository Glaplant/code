...
(async () => {
    const files = readDir.readSync('../../../../../Desktop/heic/',['*.heic']);
    console.log(files);
    files.forEach( async (file) => {
  const inputBuffer = await promisify(fs.readFile)(`../../../../../Desktop/heic/${file}`);
...
//  console.log(fileName.name);
  await promisify(fs.writeFile)(`../../../../../Desktop/heic/${fileName.name}.jpg`, outputBuffer);
    });
})();
